...
export default function Card2({}) {
  return (
    <article className="flex h-full min-h-screen flex-col justify-evenly text-center ">
      ...
      <div className="animate-fade-in-up-2 px-10 text-xs leading-[1.4] line-clamp-6 sm:text-2xl  sm:leading-[1.37]">
        <p>좋은 송아지, 어떻게 알아보셨나요?</p>
        <p>수십년간 축적된 경험과 눈썰미가 없더라도 괜찮습니다.</p>
        <p>2,300,000 건 이상 축적된 혈통, 이력 및 출하와 앤틀러의</p>
        <p>
          차별화된 빅데이터를 분석을 통해 숨어있는 <br className="md:hidden" />{" "}
          보석같은 송아지를 찾아보세요!
        </p>
