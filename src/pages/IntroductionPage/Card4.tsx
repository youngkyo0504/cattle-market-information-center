...
export default function Card4({}) {
  return (
    <article className=" flex h-full flex-1 flex-col items-center justify-end text-center font-bold">
      ...
      <div className=" mb-[15%] animate-fade-in-up cursor-pointer rounded-4xl bg-white px-3.5 py-2 text-xs font-bold leading-[1.63] tracking-[-0.3px] transition ease-in hover:bg-white/90 sm:px-[3.25rem] sm:py-4 sm:text-2xl  sm:tracking-[-0.59px]">
